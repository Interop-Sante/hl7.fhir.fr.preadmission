...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DocumentReference">
      <sch:assert test="count(f:extension[@url = 'https://interop-sante.fr/fhir/StructureDefinition/DocumentTypeFr']) &gt;= 1">extension with URL = 'https://interop-sante.fr/fhir/StructureDefinition/DocumentTypeFr': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://interop-sante.fr/fhir/StructureDefinition/DocumentTypeFr']) &lt;= 1">extension with URL = 'https://interop-sante.fr/fhir/StructureDefinition/DocumentTypeFr': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
