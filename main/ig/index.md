...
```json
{
  ...
  "id" : "hl7.fhir.fr.preadmission",
  "url" : "http://hl7.fr/fhir/fr/preadmission/ImplementationGuide/hl7.fhir.fr.preadmission",
  "version" : "0.1.0",
  "name" : "PREAD",
  "title" : "Préadmission en ligne",
  "status" : "draft",
  ...
  "packageId" : "hl7.fhir.fr.preadmission",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [
    {
    ...
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "http://hl7.fr/fhir/fr/preadmission/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
    ...
    "resource" : [
      {
        ...
        "exampleCanonical" : "http://hl7.fr/fhir/fr/preadmission/StructureDefinition/fr-patient"
      },
      {
        "extension" : [
          {
